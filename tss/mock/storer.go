...
// Source: ./tss/ecdsa/resharing/resharing.go
...
func (m *MockSaveDataStorer) GetKeyshare() (keyshare.ECDSAKeyshare, error) {
	m.ctrl.T.Helper()
...
func (m *MockSaveDataStorer) StoreKeyshare(keyshare keyshare.ECDSAKeyshare) error {
	m.ctrl.T.Helper()
